...
# The click of the button runs the proccess of capturing and image and classifitiny then playin the corosponding mp3 sound 
def button_callback(channel):
    ...
    # based on classification it goes into mp3 folder and finds the matching sound to detection
